...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        <div class="bg-dark-surface rounded-lg shadow-xl border border-gray-700 p-6">
            <h1 class="text-3xl font-orbitron font-bold text-white mb-6">Credit Card Payment</h1>
            ...
            <form method="post" class="space-y-6">
                <div class="bg-blue-900 border border-blue-700 rounded-lg p-4">
                    <p class="text-blue-200 text-sm">
                        Enter your credit card information securely. All data is encrypted and processed safely.
                    </p>
                </div>
                ...
                {if $total}
                    <div class="bg-dark-bg rounded-lg p-4 border border-gray-600">
                        <div class="flex justify-between items-center">
                            <span class="text-lg text-white">Total Amount:</span>
                ...
                <div>
                    <label class="flex items-center">
                        <input type="checkbox" name="savecard" class="mr-3">
                        <span class="text-text-light">Save this card for future payments</span>
                    </label>
                </div>
