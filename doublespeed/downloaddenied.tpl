...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        <div class="bg-dark-surface rounded-lg shadow-xl border border-gray-700 p-6">
            <h1 class="text-3xl font-orbitron font-bold text-white mb-6">Download Access Denied</h1>
            ...
            <div class="text-center space-y-6">
                ...
                <div>
                    ...
                    <p class="text-text-light mb-6">
                        You don't have permission to download this file. Please ensure you have an active subscription or contact support.
                    </p>
                </div>
                ...
                <div class="space-y-4">
                    ...
                    <a href="{$WEB_ROOT}/contact.php" class="btn-outline w-full block text-center">
                        Contact Support
                    </a>
                </div>
            </div>
