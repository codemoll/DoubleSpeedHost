                    ...
                    <div class="card-dark">
                        <div class="flex items-start justify-between mb-4">
                            ...
                            <div class="flex space-x-2">
                                <a href="{$WEB_ROOT}/clientarea.php?action=contacts&operation=edit&id={$contact.id}" 
                                   class="text-electric-blue hover:text-neon-green transition-colors duration-300">
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z"/>
                                    </svg>
                                </a>
                                <a href="{$WEB_ROOT}/clientarea.php?action=contacts&operation=delete&id={$contact.id}" 
                        ...
                        <div class="space-y-3">
                            <div>
                                ...
                                <p class="text-text-light text-sm">{$contact.companyname}</p>
                            </div>
                            ...
                            <div class="space-y-2 text-sm">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <span class="text-text-light">{$contact.email}</span>
                                </div>
