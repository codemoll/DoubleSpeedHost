    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="text-center mb-12">
            ...
            <p class="text-lg text-text-light max-w-2xl mx-auto">
                Streamline your WordPress management with advanced tools and automation features.
            </p>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            <div class="bg-dark-surface rounded-lg border border-gray-700 p-6">
                ...
                <h3 class="text-xl font-semibold text-white mb-2">One-Click Installation</h3>
                <p class="text-text-light">Install WordPress with a single click and get your site up and running in seconds.</p>
            </div>
            ...
            <div class="bg-dark-surface rounded-lg border border-gray-700 p-6">
                ...
                <h3 class="text-xl font-semibold text-white mb-2">Security Management</h3>
                <p class="text-text-light">Keep your WordPress sites secure with automated updates and security monitoring.</p>
            </div>
            ...
            <div class="bg-dark-surface rounded-lg border border-gray-700 p-6">
                ...
                <h3 class="text-xl font-semibold text-white mb-2">Backup & Restore</h3>
                <p class="text-text-light">Automated backups with easy restore options to protect your WordPress sites.</p>
            </div>
        </div>

        <!-- CTA -->
        <div class="text-center">
            <a href="{$WEB_ROOT}/cart.php?a=add&pid=wp-toolkit-cpanel" class="btn-primary">
                Get WP Toolkit Now
            </a>
        </div>
    </div>
