    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="text-center mb-12">
            ...
            <p class="text-lg text-text-light max-w-2xl mx-auto">
                Professional email and productivity suite with advanced collaboration tools for businesses.
            </p>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            <div class="bg-dark-surface rounded-lg border border-gray-700 p-6">
                ...
                <h3 class="text-xl font-semibold text-white mb-2">Professional Email</h3>
                <p class="text-text-light">Enterprise-grade email with advanced security, spam protection, and unlimited storage.</p>
            </div>
            ...
            <div class="bg-dark-surface rounded-lg border border-gray-700 p-6">
                ...
                <h3 class="text-xl font-semibold text-white mb-2">Calendar & Tasks</h3>
                <p class="text-text-light">Integrated calendar with task management, meeting scheduling, and team collaboration.</p>
            </div>
            ...
            <div class="bg-dark-surface rounded-lg border border-gray-700 p-6">
                ...
                <h3 class="text-xl font-semibold text-white mb-2">File Sharing</h3>
                <p class="text-text-light">Secure cloud storage with file sharing, document collaboration, and version control.</p>
            </div>
        </div>

        <!-- CTA -->
        <div class="text-center">
            <a href="{$WEB_ROOT}/cart.php?a=add&pid=ox" class="btn-primary">
                Get OX App Suite
            </a>
        </div>
    </div>
